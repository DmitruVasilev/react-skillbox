...
export const MenuIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <circle cx={2.5} cy={2.5} fill="#D9D9D9" r={2.5} />
    <circle cx={2.5} cy={10} fill="#D9D9D9" r={2.5} />
    <circle cx={2.5} cy={17.5} fill="#D9D9D9" r={2.5} />
  </svg>
);
...
export const ShareIcon = (props) => (
  <svg height="512" viewBox="0 0 512 512" width="512" {...props}>
    <g><g>
      <circle cx="156" cy="256" r="25"/>
      <circle cx="336" cy="356" r="25"/>
      <circle cx="336" cy="156" r="25"/>
